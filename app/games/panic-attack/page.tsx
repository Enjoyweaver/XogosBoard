  ...
  const gameFeatures = [
    {
      ...
      description: "Learn proven techniques to manage stress and anxiety through interactive scenarios and breathing exercises."
    },
    {
      icon: "💚",
      title: "Emotional Intelligence",
      description: "Develop emotional awareness and regulation skills through guided experiences and self-reflection activities."
    },
    {
      icon: "🛡️",
      title: "Coping Strategies",
      description: "Build a personalized toolkit of healthy coping mechanisms for dealing with overwhelming emotions."
    },
    {
      icon: "🌱",
      title: "Mindfulness Training",
      description: "Practice mindfulness and grounding techniques that can be applied in real-life stressful situations."
    },
    {
      icon: "📚",
      title: "Educational Content",
      description: "Understand the science behind stress, anxiety, and emotional regulation in an age-appropriate way."
    },
    {
      icon: "🎯",
      title: "Progress Tracking",
      description: "Monitor your emotional growth and celebrate milestones in your mental wellness journey."
    }
  ];
  ...
  const gameplayMechanics = [
    {
      ...
      description: "Navigate through common stressful situations like test anxiety, social pressure, and family conflicts.",
      image: "/images/games/mechanics/scenarios.jpg"
    },
    {
      title: "Breathing Exercises",
      description: "Practice guided breathing techniques with visual and audio cues to help calm your mind and body.",
      image: "/images/games/mechanics/breathing.jpg"
    },
    {
      title: "Emotion Mapping",
      description: "Identify and track your emotions throughout different situations to build self-awareness.",
      image: "/images/games/mechanics/emotions.jpg"
    },
    {
      title: "Coping Toolkit",
      description: "Collect and customize healthy coping strategies that work best for your personality and situations.",
            ...
            <div className={styles.heroContent}>
              ...
              <div className={styles.heroRight}>
                <h1 className={`${styles.heroTitle} ${isLoaded ? styles.visible : ""}`}>
                  Learn to Navigate Life's <span className={styles.highlightText}>Challenges</span>
                </h1>
                <p className={`${styles.heroDescription} ${isLoaded ? styles.visible : ""}`}>
                  An innovative educational game that teaches stress management and mental health awareness. 
                  Navigate through real-life challenges while learning coping strategies, emotional intelligence, 
                  and healthy habits in a safe, supportive environment.
                </p>
                <div className={`${styles.heroActions} ${isLoaded ? styles.visible : ""}`}>
                ...
                <div className={styles.ageRating}>
                  ...
                  <span className={styles.ratingText}>With parental guidance recommended</span>
                </div>
              </div>
            </div>
          </Container>
              ...
              <div className={styles.tabContent}>
                <div className={styles.sectionHeading}>
                  ...
                  <p className={styles.sectionSubtitle}>
                    Discover the tools and techniques that make Panic Attack!! an effective learning experience
                  </p>
                </div>
            ...
            {activeTab === "gameplay" && (
              <div className={styles.tabContent}>
                <div className={styles.sectionHeading}>
                  ...
                  <p className={styles.sectionSubtitle}>
                    Explore interactive mechanics designed to teach real-world emotional regulation skills
                  </p>
                </div>
                    ...
                    <div key={index} className={styles.gameplayCard}>
                      <div className={styles.gameplayImageContainer}>
                        <div className={styles.gameplayImagePlaceholder}>
                          <span className={styles.placeholderText}>{mechanic.title}</span>
                        </div>
                      </div>
                      <div className={styles.gameplayContent}>
                        <h3 className={styles.gameplayTitle}>{mechanic.title}</h3>
                        <p className={styles.gameplayDescription}>{mechanic.description}</p>
                      </div>
                    </div>
                  ))}
                </div>
            ...
            {activeTab === "learning" && (
              <div className={styles.tabContent}>
                <div className={styles.sectionHeading}>
                  ...
                  <p className={styles.sectionSubtitle}>
                    Educational goals and skills students will develop through gameplay
                  </p>
                </div>
                
                <div className={styles.learningContent}>
                  <div className={styles.objectivesList}>
                    <h3 className={styles.objectivesTitle}>By the end of this experience, students will be able to:</h3>
                  ...
                  <div className={styles.curriculumInfo}>
                    <h3 className={styles.curriculumTitle}>Curriculum Alignment</h3>
                    <div className={styles.curriculumCards}>
                      <div className={styles.curriculumCard}>
                        <h4>Social-Emotional Learning (SEL)</h4>
                        <p>Self-awareness, self-management, and responsible decision-making competencies</p>
                      </div>
                      <div className={styles.curriculumCard}>
                        <h4>Health Education Standards</h4>
                        <p>Mental and emotional health, stress management, and coping strategies</p>
                      </div>
                      <div className={styles.curriculumCard}>
                        <h4>Life Skills Development</h4>
                        <p>Problem-solving, critical thinking, and emotional regulation techniques</p>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div className={styles.safetyContent}>
                  <div className={styles.safetyNotice}>
                    ...
                    <div className={styles.noticeContent}>
                      ...
                      <p>
                        Panic Attack!! is designed as an educational tool to support mental wellness learning. 
                        It is not intended to replace professional mental health care or therapy. If you or 
                        someone you know is experiencing a mental health crisis, please seek help immediately.
                      </p>
                    </div>
                  </div>
        ...
        <section className={styles.ctaSection}>
          <Container>
            <div className={styles.ctaContent}>
              <h2 className={styles.ctaTitle}>Ready to Build Emotional Resilience?</h2>
              <p className={styles.ctaDescription}>
                Join students who are learning valuable life skills through engaging, evidence-based gameplay. 
